            ...
            <tr>
              ...
              <td>
                <div class="upload-actions">
                  <a href="admin_document/document_view.php?id=<?php echo $row['documents_id']; ?>" class="action-btn view-btn"><i class="fas fa-eye"></i> View</a>
                  <a href="admin_document/document_edit.php?id=<?php echo $row['documents_id']; ?>" class="action-btn edit-btn"><i class="fas fa-edit"></i> Edit</a>
                  <a href="admin_document/document_delete.php?id=<?php echo $row['documents_id']; ?>" class="action-btn delete-btn" onclick="return confirm('Delete this file?')"><i class="fas fa-trash"></i> Delete</a>
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
