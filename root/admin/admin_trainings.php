            ...
            <tr>
              ...
              <td>
                <div class="upload-actions">
                  <a href="admin_training/training_view.php?id=<?php echo $row['training_id']; ?>" class="action-btn view-btn"><i class="fas fa-eye"></i> View</a>
                  <a href="admin_training/training_edit.php?id=<?php echo $row['training_id']; ?>" class="action-btn edit-btn"><i class="fas fa-edit"></i> Edit</a>
                  <a href="admin_training/training_delete.php?id=<?php echo $row['training_id']; ?>" class="action-btn delete-btn" onclick="return confirm('Delete this file?')"><i class="fas fa-trash"></i> Delete</a>
                </div>
              </td>
            </tr>
          <?php endforeach; ?>
