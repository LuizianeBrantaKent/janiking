...
<div class="admin-navbar">
    <ul class="nav-menu">
        ...
        <li class="nav-item">
            <a href="/admin/admin_trainings.php" class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='admin_trainings.php') echo 'active'; ?>">
                <i class="fas fa-file-upload"></i>
                <span class="nav-text">Upload Trainings</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="/admin/admin_documents.php" class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='admin_documents.php') echo 'active'; ?>">
                <i class="fas fa-file-upload"></i>
