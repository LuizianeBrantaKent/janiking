...
<div class="app">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="active" href="#"><i class="fa fa-user"></i><span>Profile / Settings</span></a>
    </nav>
  ...
  <header class="header">
    <div class="user">
      <div class="text-end me-2"><strong><?= e($user['name'] ?? 'Staff') ?></strong><small class="d-block" style="color:var(--muted)"><?= e($user['role'] ?? 'Staff') ?></small></div>
      ...
      <div class="cardx">
        ...
        <div class="card-body">
          <form method="post" class="stack">
            ...
            <button class="btnx btnx-primary">Save changes</button>
          </form>
        </div>
      </div>
        ...
        <div class="cardx">
          ...
          <div class="card-body">
            <form method="post">
              ...
              <button class="btnx btnx-primary">Update password</button>
            </form>
          </div>
        </div>
